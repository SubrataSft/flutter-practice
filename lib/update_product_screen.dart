...
class _UpdateProductScreenState extends State<UpdateProductScreen> {
  ...
  void initState() {
    ...
    _totalTEController.text = widget.product.total?? "";
  ...
  Future<void> _updateProduct() async {
    ...
    if(response.statusCode == 200){
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text("This product is updated!")));
    Navigator.pop(context,true);
    }else{
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text("This product is failed!")));
    }
  }
